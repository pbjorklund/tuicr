...
├── update/
│   ├── check.rs         # Lightweight GitHub release checks for the TUI badge
│   ├── source.rs        # Shared GitHub release endpoint and asset target mapping
